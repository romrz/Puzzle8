...
public class BFSSolver implements Solver {
    //En la busqueda en anchura se incrementa el uso de la memoria de una manera exponencial.
    ...
    public ArrayList<Direction> solve(Board begin, Board end, int limit){
        ...
        //limit indica el maximo nivel de profundidad en el cual se puede buscar.
